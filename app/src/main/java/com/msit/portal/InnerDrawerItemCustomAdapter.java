 ...
 */
public class InnerDrawerItemCustomAdapter extends ArrayAdapter<ObjectInnerDrawerItem> {

    Context mContext;
    int layoutResourceId;
    ObjectInnerDrawerItem data[] = null;
     ...
     */
    public InnerDrawerItemCustomAdapter(Context mContext, int layoutResourceId, ObjectInnerDrawerItem[] data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
		 ...
		 * want.
		 */
        ObjectInnerDrawerItem folder = data[position];
